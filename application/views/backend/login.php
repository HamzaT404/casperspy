...
<head>
	...
	<title><?php echo get_phrase('login');?> | <?php echo $customer_title;?></title>
		...
		<div class="login-content">
			...
			<form method="post" role="form" id="form_login">
				...
				<div class="form-group">
					...
					<br>
					<a href="<?php echo base_url().'?login/login_otp';?>" class="btn btn-primary btn-block btn-login">
						<i class="entypo-login"></i>
						Login via OTP
					</a>
				</div>
				...
				<!-- <div class="btn-group">
						...
						<a type="button" href="<?php echo base_url();?>index.php?frontend/forgot_password"  class="btn btn-blue btn-lg"><font color="white"><?php echo get_phrase('forgot_password');?> ?</font></a>
