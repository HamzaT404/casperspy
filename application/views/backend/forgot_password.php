...
<html lang="en">
    <head>
        ...
        <title><?php echo get_phrase('reset_password'); ?> | <?php echo $customer_title; ?></title>
        ...
        <div class="login-container">
            ...
            <div class="login-header login-caret">
                ...
                <div class="login-content" style="width:100%;">
                    ...
                    <p class="description">Enter your email to reset password.</p>
            ...
            <div class="login-form">
                ...
                <div class="login-content">
                   ...
                   <?php echo form_open(base_url() . 'index.php?login/ajax_forgot_password/' , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
