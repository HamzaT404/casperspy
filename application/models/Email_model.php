...
class Email_model extends CI_Model {
	...
	function account_opening_email($account_type = '' , $email = '')
	{
		...
		$email_msg		=	"Welcome to ".$customer_title."<br />";
		...
		$email_msg		.=	"Login Here : ".base_url('index.php?frontend/login')."<br />";
	...
	function do_email($msg=NULL, $sub=NULL, $to=NULL, $from=NULL)
	{
        ...
        $config['smtp_user']	= "admin@hasim751.com";
        $config['smtp_pass']	= "751@hr751";
		...
		$msg	=	$msg."<br /><br /><br /><br /><br /><br /><br /><hr /><center><a href=\"http://barkatekhwaja.net/\">&copy; 2016 Barkat-e-Khwaja</a></center>";
